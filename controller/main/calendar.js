...
export async function create(req, res){
    ...
    const { C_TITLE, C_START, C_END, C_CONTENT, C_ALARM } = req.body;
    const calendar = await calendarRepository.insert({ U_NUM, C_TITLE, C_START, C_END, C_CONTENT, C_ALARM });
...
export async function modify(req, res){
    ...
    if(calendar){
        const updated = await calendarRepository.update({ C_NUM, C_TITLE, C_START, C_END, C_CONTENT, C_ALARM });
